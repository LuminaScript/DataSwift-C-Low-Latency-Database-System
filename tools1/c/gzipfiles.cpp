...
int main(int argc,char *argv[])
{
  ...
  if (argc != 4)
  {
    ...
    printf("Example:sudo ./gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("        sudo ./gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n");
    printf("        sudo ./procctl 300 /project/tools1/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("        sudo ./procctl 300 /project/tools1/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n\n");
