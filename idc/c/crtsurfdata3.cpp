...
int main(int argc, char *argv[]){
 ...
 if(argc != 4){
  printf("Using: sudo ./crtsurfdata3 inifile outpath logfile\n");
  printf("Example: sudo ./crtsurfdata3 /home/yizhen/Desktop/project/idc/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata3.log\n\n");
